...
const AtomIcon: React.FC<IconProps> = (props) => (
...
const MoleculeIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 100 100" {...props}>
    {/* Central atoms */}
...
const DnaIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 100 100" {...props}>
...
const CellIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 100 100" {...props}>
...
const SpleenIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 100 100" {...props}>
    {/* Outer spleen shape */}
    <path
...
const PersonIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 100 100" {...props}>
...
const transformItems = (data: { items: ItemData[] }): Item[] => {
  return data.items.map((item) => ({
    id: item.id,
    label: item.label,
    text: item.text,
    Icon: iconMap[item.icon] || AtomIcon, // Fallback to AtomIcon if icon not found
  }));
};

const items: Item[] = transformItems(data);
